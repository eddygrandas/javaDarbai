...
public class DatabaseService {
    private static final String DATABASE_URL = "jdbc:mysql://localhost:3306/zioplys?useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=UTC";
    ...
    private static final String INSERT_PHONE_NUMBER = "INSERT INTO employee (phone_number,person_id) VALUES(?, ?)";
